...
import natalie_bot.modules.sql.notes_sql as sql
from natalie_bot import dispatcher, MESSAGE_DUMP, LOGGER, CMD_PREFIX
...
from natalie_bot.modules.helper_funcs.msg_types import get_note_type
