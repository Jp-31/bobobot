...
STICKERID_HANDLER = DisableAbleCommandHandler(CMD_PREFIX, "stickerid", stickerid)
GETSTICKER_HANDLER = DisableAbleCommandHandler(CMD_PREFIX, "getsticker", getsticker)
KANG_HANDLER = DisableAbleCommandHandler(CMD_PREFIX, "kang", kang, admin_ok=True)
