...
from natalie_bot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL, CMD_PREFIX
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from natalie_bot.modules import ALL_MODULES
from natalie_bot.modules.helper_funcs.chat_status import is_user_admin, can_message
...
from natalie_bot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("natalie_bot.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) > 1:
            ...
            keyboard = [[InlineKeyboardButton(text="Add me to group", 
